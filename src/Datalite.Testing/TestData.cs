...
namespace Datalite.Testing
{
    ...
    {
        /// <summary>
        /// The default SQL for query testing.
        /// </summary>
        ...
        /// <summary>
        /// The expected number of returned rows from the table.
        /// </summary>
        public static int ExpectedTableRows => 1000;

        /// <summary>
        /// The expected number of returned rows from the query.
        /// </summary>
        ...
        /// <summary>
        /// An index on 'last_name' and 'gender'.
        /// </summary>
        ...
        /// <summary>
        /// Standard test criteria for the Foo table.
        /// </summary>
        /// <param name="table">The Sqlite table.</param>
        /// <returns></returns>
