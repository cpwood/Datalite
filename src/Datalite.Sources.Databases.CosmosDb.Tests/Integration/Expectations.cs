...
namespace Datalite.Sources.Databases.CosmosDb.Tests.Integration
{
    ...
    {
        internal static SqliteColumn IdColumn => new("id", StoragesClasses.StorageClassType.TextClass, true);
        ...
        internal static SqliteColumn TimestampColumn = new("_ts", StoragesClasses.StorageClassType.IntegerClass, true);
        ...
        internal static string[] Index = { "id" };
